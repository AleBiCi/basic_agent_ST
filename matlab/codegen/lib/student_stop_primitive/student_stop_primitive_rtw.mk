###########################################################################
## Makefile generated for component 'student_stop_primitive'. 
## 
## Makefile     : student_stop_primitive_rtw.mk
## Generated on : Thu Oct 16 13:14:34 2025
...
PRODUCT_NAME              = student_stop_primitive
MAKEFILE                  = student_stop_primitive_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2024b.app
MATLAB_BIN                = /Applications/MATLAB_R2024b.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/alessandrobianchiceriani/Desktop/Scrivania_MPB/ALE_VARIE_DONTTOUCH/UNITN/MAGISTRALE/Secondo_Anno/IVAD/Repos/basic_agent_ST/matlab
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/student_stop_primitive -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
SRCS = $(START_DIR)/codegen/lib/student_stop_primitive/rt_nonfinite.c $(START_DIR)/codegen/lib/student_stop_primitive/rtGetNaN.c $(START_DIR)/codegen/lib/student_stop_primitive/rtGetInf.c $(START_DIR)/codegen/lib/student_stop_primitive/student_stop_primitive.c
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o student_stop_primitive.o
...
%.o : $(START_DIR)/codegen/lib/student_stop_primitive/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/student_stop_primitive/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/student_stop_primitive/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/student_stop_primitive/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/student_stop_primitive/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/student_stop_primitive/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/student_stop_primitive/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/student_stop_primitive/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


student_stop_primitive.o : $(START_DIR)/codegen/lib/student_stop_primitive/student_stop_primitive.c
	$(CC) $(CFLAGS) -o "$@" "$<"
